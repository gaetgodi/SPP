...
require_once get_stylesheet_directory() . '/inc/spp-kq-format-ranking.php'; // Ace/Queen of the Courts decay-weighted format rankings (spp_kq_update_format_rankings()) -- must load after spp-kq-club-rating.php above (reuses SPP_KQ_CLUB_RATING_LAUNCH_DATE/spp_kq_category_source()) and spp-create-results.php (line 90, reuses rankUsersWithTies()); called from spp-kq-screens.php's post-action dispatcher below, same trigger point as Club Rating
