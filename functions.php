...
require_once get_stylesheet_directory() . '/inc/spp-kq-format-ranking.php'; // Ace/Queen of the Courts decay-weighted format rankings (spp_kq_update_format_rankings()) -- must load after spp-kq-club-rating.php above (reuses SPP_KQ_CLUB_RATING_LAUNCH_DATE/spp_kq_category_source()), spp-create-results.php (line 90, reuses rankUsersWithTies()), and spp-kq-movement.php (line 98, reuses spp_kq_compute_next_round()/SPP_KQ_Movement_Error for the hypothetical-next-court score); called from spp-kq-screens.php's post-action dispatcher below, same trigger point as Club Rating
