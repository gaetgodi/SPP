...
function spp_get_registrants_ajax() {
    ...
    // Build BCC mailto for Email All button (confirmed only)
    ...
    if ( ! empty( $waiting ) ) {
        ...
        $html .= '</tbody></table>';
        $html .= '<p class="spp-registrant-count" style="color:#c0392b;">'
               . count( $waiting ) . ' on waiting list'
               . '</p>';
    }
